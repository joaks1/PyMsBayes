...
:math:`M_1 = 111` to show that we are assigning population pairs 1, 2, and 3 to
divergence-time parameter 1.
However, this is only one possible divergence model, and is the most
constrained.
With three population pairs, there are 5 possible models of divergence.  We can
add a second divergence-time parameter and assign it to population pair 1 to
get divergence model :math:`M_2 = 211`, as shown in the divergence_model_211_
figure.
...
We can also assign divergence-time parameter 2 to population pair 2 to get
...
we assign divergence-time parameter 2 to population pair 3 to get divergence
